...
const DashboardPage = () => {
  ...
  return (
    <DashboardContainer>
      ...
      <TabContainer>
        <TabButton onClick={() => handleTabClick('upload')} style={{ backgroundColor: activeTab === 'upload' ? '#6a1b9a' : '#4a148c' }}>
          Upload Document
        </TabButton>
        <TabButton onClick={() => handleTabClick('list')} style={{ backgroundColor: activeTab === 'list' ? '#6a1b9a' : '#4a148c' }}>
          Signed Document List
        </TabButton>
        <TabButton onClick={() => handleTabClick('search')} style={{ backgroundColor: activeTab === 'search' ? '#6a1b9a' : '#4a148c' }}>
          Search Document
        </TabButton>
      </TabContainer>
